...
function add_parvas_list_bs(month, year) {
  ...
  var international_event_url = 'https://bhupendra12345678.github.io/shrayesh-dahal/data/international_events.json';
  var international_events = JSON.parse("{}");

  international_parvas_event_req.open('GET', international_event_url, true);
  ...
  if (year >= 2076 && year <= END_BS_YEAR) {
    json_url = 'https://bhupendra12345678.github.io/shrayesh-dahal/data/' + year + '_detailed.json';
  }
  else {
...
function add_parvas_list_ns(month, year) {
  ...
  var sns_event_url = 'https://bhupendra12345678.github.io/shrayesh-dahal/data/solar_ns_events.json';
