...
function tdclick(id) {
  ...
  nepal_event_req.onload = function() {
    ...
    var public1_holidays_information = add_public1_holiday_info(id, has_events);
    if (public1_holidays_information) {
      info_content += public1_holidays_information.replaceAll(" / ", "<br />");
      has_events = true;
      console.info("Public1 Holiday!!");
    }
    var public2_holidays_information = add_public2_holiday_info(id, has_events);
    if (public2_holidays_information) {
      info_content += public2_holidays_information.replaceAll(" / ", "<br />");
      has_events = true;
      console.info("Public2 Holiday!!");
    }
    var public3_holidays_information = add_public3_holiday_info(id, has_events);
    if (public3_holidays_information) {
      info_content += public3_holidays_information.replaceAll(" / ", "<br />");
      has_events = true;
      console.info("Public3 Holiday!!");
    }
