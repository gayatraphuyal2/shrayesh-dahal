...
// GET PUBLIC HOLIDAYS
var public_holiday_url = 'https://bhupendra12345678.github.io/shrayesh-dahal/data/public_holidays.json';
...
function add_public_holiday_info(complete_date, has_events) {
  ...
  if (public_holidays[public_holidays_year][public_holidays_key]) {
    ...
    public_holidays_info += "<div id='public_holiday_title'>बिदा</div>";
