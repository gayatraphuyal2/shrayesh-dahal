...
// GET EVENTS JSON
const nat_event_url = 'https://shrayesh1234.github.io/shrayesh-dahal/data/nat.json';
const int_event_url = 'https://shrayesh1234.github.io/shrayesh-dahal/data/int.json';
const solar_ns_event_url = 'https://bhupendra12345678.github.io/shrayesh-dahal/data/solar_ns_events.json';
const other_calendar_event_url = 'https://shrayesh1234.github.io/shrayesh-dahal/data/other.json';
const lunar_event_url = "https://bhupendra12345678.github.io/shrayesh-dahal/data/" + today_year + "_detailed.json";
const public_holiday_event_url = 'https://bhupendra12345678.github.io/shrayesh-dahal/data/public_holidays.json';
...
public_holiday_event_req.open('GET', public_holiday_event_url, true);
